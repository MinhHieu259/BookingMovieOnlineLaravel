...
@push('js')
    ...
    <script>
        @if ($suatChieuInfor->gioiHanTuoi == '16' || $suatChieuInfor->gioiHanTuoi == '18')
            // alert(
            //     'Theo quy định của cục điện ảnh, phim không dành cho khán giả dưới {{ $suatChieuInfor->gioiHanTuoi }} tuổi. Hãy cân nhắc trước khi tiếp tục.');
            $('#popupMessageAge').modal('show')
        @endif
        $('#popupMessageAge #btnOkAge').click(function() {
            $('#popupMessageAge').modal('hide')
        })
    </script>
@endpush
@push('css')
...
@section('content')
    <ul class="nav nav-tabs" id="myTab" role="tablist" style="display: none">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="seat-tab" data-toggle="tab" data-target="#seat" type="button"
                role="tab" aria-controls="seat" aria-selected="true">Home</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="food-tab" data-toggle="tab" data-target="#food" type="button" role="tab"
                aria-controls="food" aria-selected="false">Profile</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="pay-tab" data-toggle="tab" data-target="#pay" type="button" role="tab"
                aria-controls="pay" aria-selected="false">Contact</button>
        </li>
    </ul>
                ...
                <div class="col-lg-4 col-12 order-sm-last">
                    ...
                    <div class="flow-actions sticky-button-bars">
                        ...
                        <button type="button" id="btnContinue"
                            class="btn btn-lg btn-dark btn-ticketing-do-submit btn-block btn-ticketing-flow mt-3">Tiếp tục
                        </button>
                                                ...
                                                @foreach ($foods as $index => $food)
                                                    <tr class="ticketing-concession-type"
                                                        ...
                                                        <td class="ticketing-select text-right">
                                                            <a data-food="{{ $food->maDoAn }}"
                                                                data-price="{{ $food->gia }}"
                                                                class="btn btn-sm btn-rounded-circle btn-white btn-concession-quantity"
                                                                data-type="minus">
                                                                -
                                                            </a>
                                                            <input data-ten="{{ $food->tenDoAn }}"
                                                                name="food_{{ $food->maDoAn }}"
                                                                id="food_{{ $food->maDoAn }}" type="text"
                                                                min="0" max="10" style="width: 35px"
                                                                class="form-control form-control-flush text-center d-inline"
                        ...
                        <div class="tab-pane fade" id="pay" role="tabpanel" aria-labelledby="pay-tab">
                            <div class="ticketing-content ticketing-checkout-page">
                                ...
                                <div class="card mt-5" style="width: 100%">
                                    ...
                                    <div class="card-body">
                                        <div class="payment-gateway pg-momo clearfix active" data-pg="momo"
                                            data-pm="">
                                            <div class="row">
                                        ...
                                        <div class="payment-gateway pg-moveek pm-moveek-credits clearfix moveek-credits-guide"
                                            ...
                                            <div class="row">
                                                ...
                                                <label class="pg-info" for="credit">
                                                    <img width="28px"
                                                        src="{{ asset('assets/images/user/mascot.png') }}">
                                                    CineBooker Credits
                                                    <br>
                                                    <span class="pm-description">
                                                        Số dư CineBooker Credits: <strong
                                                            class="text-dark">{{ number_format(Auth::guard('nguoidung')->user()->soDu) }}
                                                            đ</strong>
                                                    </span>
                                                </label>
                                            </div>
...
@push('popup')
    @include('layouts.includes.user.popup.popup-message-age')
