            ...
            <div id="carouselExampleIndicators" class="carousel slide mb-3" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item {{$index == 0 ? 'active' : ''}}">
                       <a href="{{route('LichChieuView', ['slug' => $slider->slug])}}">
                        
                            <img class="d-block w-100" src="{{ asset($slider->slider) }}"
                                alt="First slide">
                        ...
                        <div class="item">
                            <div class="card card-carousel">
                                <a href="lich-chieu/{{ $film->slug }}">
                                    <img src="{{ asset($film->linkHinhAnh) }}" alt="anhFilm" class="card-img-top" />
                        ...
                        <div class="card-body">
                            @foreach ($post as $item)
                                <div class="review-new">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img width="350" src="{{ asset($item->hinhAnh) }}" alt="Anh">
                                        </div>
                                        <div class="col-md-8">
                                            <a class="name-review"
                                                href="{{ route('DetailPost', ['slug' => $item->slug]) }}">{{ $item->tieuDe }}</a>
