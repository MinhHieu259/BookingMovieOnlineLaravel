...
@section('title', 'Thêm mới danh mujc phim')
@push('js')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Thêm mới danh mục phim</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger input-error" id="tenDanhMucError"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-primary" id="btnSaveDanhMuc">Lưu thông tin</button>
                            </div>
                        </form>
                    </div>
                </div>
