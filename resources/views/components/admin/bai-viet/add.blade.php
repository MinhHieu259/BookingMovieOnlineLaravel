                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="maPhim" class="form-control select2 select2-hidden-accessible"
                                                style="width: 100%;" tabindex="-1" aria-hidden="true"
                                                data-select2-id="maPhim">
                                                @foreach ($films as $index => $film)
                                                    <option value="{{ $film->maPhim }}">{{ $film->tenPhim }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <span class="text-danger input-error" id="maPhimError"></span>
                                        </div>
                                    </div>
                                </div>
...
@push('js')
    ...
    <script src="{{ asset('admin/function/bai-viet/add.js') }}"></script>
    ...
    <script>
        //  var editerPost = CKEDITOR.replace( 'noiDungBaiViet' );
    </script>
@endpush
